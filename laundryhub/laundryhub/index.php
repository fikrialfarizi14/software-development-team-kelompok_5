...
// Hanya pelanggan yang bisa akses ini
...
$layanan_list = mysqli_query($koneksi, "SELECT * FROM layanan ORDER BY harga_per_kg ASC");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Ambil harga layanan
    $lyr = mysqli_query($koneksi, "SELECT * FROM layanan WHERE id = $layanan_id");
    ...
    if ($lyr_data && $berat_kg > 0) {
        ...
        $query = "INSERT INTO pesanan (kode_pesanan, user_id, layanan_id, berat_kg, total_harga, alamat_pickup, catatan)
                  VALUES ('$kode', $user_id, $layanan_id, $berat_kg, $total_harga, '$alamat_pickup', '$catatan')";
...
$pesanan_saya = mysqli_query($koneksi,
    "SELECT p.*, l.nama_layanan FROM pesanan p 
...
<div class="navbar">
    ...
    <div>
        <span style="color:#fff;">Halo, <?= $_SESSION['nama'] ?></span>
